...
const VisitsPage = () => {
  ...
  const fetchVisits = async () => {
    ...
    try {
      ...
      const res = await fetch(`http://localhost:5000/api/admin/visits/user/${userId}?${params}`, {
        headers: {
  ...
  const fetchSummary = async () => {
    ...
    try {
      ...
      const res = await fetch(`http://localhost:5000/api/admin/visits/summary?${params}`, {
        headers: {
          Authorization: `Bearer ${token}`,
          Accept: "application/json",
        },
  ...
  const fetchVisitDetail = async (id: string) => {
    ...
    try {
      ...
      const res = await fetch(`http://localhost:5000/api/admin/visits/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
          Accept: "application/json",
        },
